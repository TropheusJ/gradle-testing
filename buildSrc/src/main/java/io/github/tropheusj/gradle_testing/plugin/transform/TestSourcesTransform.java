...
public abstract class TestSourcesTransform implements TransformAction<TransformParameters.None> {
	@InputArtifact
	...
	public void transform(TransformOutputs outputs) {
		...
		String outputName = input.getName().replace(".jar", "-transformed-s.jar");
